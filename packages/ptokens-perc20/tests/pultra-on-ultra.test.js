...
const ULTRA_TESTING_ACCOUNT_NAME_1 = ''
const ULTRA_TESTING_ACCOUNT_NAME_2 = ''
const PNETWORK_NODE = ''
...
test('Should issue 0.02 pULTRA', async () => {
  ...
  const start = () =>
    new Promise(resolve => {
      puos
        .issue(amountToIssue, ULTRA_TESTING_ACCOUNT_NAME_1, {
          gasPrice: 75e9,
          gas: 200000
        })
  ...
  const start = () =>
    new Promise(resolve => {
      puos
        .issueWithMetadata(
          amountToIssue,
          ULTRA_TESTING_ACCOUNT_NAME_2,
          web3.utils.utf8ToHex(ULTRA_TESTING_ACCOUNT_NAME_1),
          {
            gasPrice: 20e9,
            gas: 200000
          }
    ...
    new Promise((resolve, reject) => {
      puos
        .redeem(amountToRedeem, ETH_TESTING_ADDRESS, {
          ...
          expireSeconds: 60,
          permission: 'active',
          actor: ULTRA_TESTING_ACCOUNT_NAME_1
        })
        .once('hostTxConfirmed', () => {
          ultraTxConfirmed = true
        })
